...
ab_aca_dataset <- read_csv(here("data", "tidy_ab_aca_pca_data.csv")) %>%
...
ab_aca_pca <- ab_aca_dataset %>% #assigning the loaded dataset to an object
...
test_plot <- ab_aca_pca %>% #assigning the PCA results to an object
