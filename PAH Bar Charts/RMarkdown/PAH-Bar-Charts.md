...
```
## here() starts at /Users/blake/Library/Mobile Documents/com~apple~CloudDocs/Desktop/CEOS Technician/R/PAH Bar Charts
```
...
## dbl (35): oil_concentration, Naph, x2MNaph, x1MNaph, x16DMNaph, Acy, Ace, x2...
## 
...
##    <chr>             <chr>      <chr>     <chr>         <dbl>
##  1 5                 y          5FT0      Naph        3.96   
##  2 5                 y          5FT0      x2MNaph    28.3    
##  3 5                 y          5FT0      x1MNaph    18.7    
##  4 5                 y          5FT0      x16DMNaph  24.2    
##  5 5                 y          5FT0      Acy         0.979  
##  6 5                 y          5FT0      Ace         1.16   
##  7 5                 y          5FT0      x235TMNaph 12.6    
##  8 5                 y          5FT0      Fluor       1.89   
##  9 5                 y          5FT0      DBThio      0.00412
## 10 5                 y          5FT0      Phen        0.845  
## # ℹ 398 more rows
```
...
## 1 5                 y          <tibble [102 × 3]> <gg>   5_y_plot.png  
## 2 50                n          <tibble [102 × 3]> <gg>   50_n_plot.png 
## 3 50                y          <tibble [102 × 3]> <gg>   50_y_plot.png 
## 4 500               y          <tibble [102 × 3]> <gg>   500_y_plot.png
```
